// Exercicio_2_2_b.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	if (Possi)
		cout << "Sao medidas de 1 triangulo";
	else
		cout << "NAO sao medidas de 1 triangulo";
